...
void ApplicationApplication__Init( ApplicationApplication _this, XObject aLink, XHandle aArg )
{
  ...
  Screenwind__Init( &_this->wind, &_this->_.XObject, 0 );
  ...
  CoreRectView__OnSetBounds( &_this->wind, _Const0000 );
  CoreGroup_Add((CoreGroup)_this, ((CoreView)&_this->wind ), 0 );
}
...
EW_DEFINE_CLASS( ApplicationApplication, CoreRoot, wind, _.VMT, _.VMT, _.VMT, _.VMT, 
