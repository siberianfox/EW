...
C.W={bitmap:null,FrameDelay:0,NoOfFrames:1,FrameSize:B.vw,EW:false,Ei:false,Eo:function(
){if(!this.bitmap)return;var handle=this.bitmap;B.zx(handle);this.bitmap=null;this.
FrameSize=A9;this.FrameDelay=0;this.NoOfFrames=1;this.Ei=false;},Ai:function(aArg
...
this.FrameSize=frameSize;this.FrameDelay=frameDelay;this.EW=true;this.Ei=(!!this.
bitmap&&(this.FrameDelay>0))&&(this.NoOfFrames>1);},Ln:function(E){throw new Error(
Bc);},Update:function(){},_Init:function(aArg){B.Core.He._Init.call(this,aArg);this.
__proto__=C.W;this.Ai(aArg);},_Done:function(){this.Eo();this.__proto__=B.Core.He;
B.Core.He._Done.call(this);},_className:"Resources::Bitmap"};C.A5={font:null,Leading:
0,Descent:0,Ascent:0,Eo:function(){this.Zj();},Ai:function(aArg){this.Zo(aArg);}
,Zj:function(){if(!this.font)return;var handle=this.font;B.zy(handle);this.font=
null;this.Ascent=0;this.Descent=0;this.Leading=0;},Zo:function(aFontResource){if(
...
,aString,aOffset,aCount,aX,aMinWidth);return col;},Ru:function(aFlowString){if(!
...
aMaxNoOfRows,aBidi);return result;},G8:function(aString,aOffset,aCount){if(aOffset<
...
},_Init:function(aArg){B.Core.He._Init.call(this,aArg);this.__proto__=C.A5;this.
Ai(aArg);},_Done:function(){this.Eo();this.__proto__=B.Core.He;B.Core.He._Done.call(
this);},_className:"Resources::Font"};C.BB={_class:function(){return C.A5;},0:{Data:
function(){return B.abo;},Cache:[],_this:null}};C.IG={_class:function(){return C.
A5;},0:{Data:function(){return B.abn;},Cache:[],_this:null}};C.Kg={_class:function(
){return C.W;},0:{FileName:"./res/ResourcesWhiteBitmapStripe.png",Format:B.jt,NoOfFrames:
1,FrameSize:[256,4],FrameDelay:0,_this:null}};
C._Init=function(){C.W.__proto__=B.Core.He;C.A5.__proto__=B.Core.He;};C._ReInit=function(
){};C.C7=function(D){var A;if((A=C.BB[0]._this)&&(A._cycle!=D))A._Done(C.BB[0]._this=
null);if((A=C.IG[0]._this)&&(A._cycle!=D))A._Done(C.IG[0]._this=null);if((A=C.Kg[
0]._this)&&(A._cycle!=D))A._Done(C.Kg[0]._this=null);};return C;})();
