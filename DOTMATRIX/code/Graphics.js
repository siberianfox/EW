...
C.Canvas={A3:null,MR:null,Es:B.vx,Eq:0,LQ:false,Ep:function(){if(this.LQ)this.DetachBitmap(
...
this.Eq;for(this.Eq=this.NoOfFrames-1;this.Eq>=0;this.Eq--)this.MD(this.Es,this.
...
]>0))(A=this.MR)?A[1].call(A[0],this):null;this.Es=DK;}},DetachBitmap:function(){
...
this.FrameDelay>0)&&(this.NoOfFrames>1);return this;},Rs:function(aClip,Qq,aString
,aOffset,aCount,aDstRect,aSrcPos,aMinWidth,Qs,aColorTL,aColorTR,aColorBR,aColorBL
,aBlend){if(!this.bitmap)this.Update();if(!this.bitmap)return;if(aOffset<0)aOffset=
0;if((!Qq||!Qq.font)||((aOffset>0)&&(aOffset>=aString.length)))return;var orient=
0;if(Qs===1)orient=90;else if(Qs===2)orient=180;else if(Qs===3)orient=270;var dstFrameNo=
this.Eq;var dstBitmap=this.bitmap;var srcFont=Qq.font;{B.qT(dstBitmap,srcFont,aString
,aOffset,aCount,dstFrameNo,aClip,aDstRect,aSrcPos,aMinWidth,orient,aColorTL,aColorTR
,aColorBR,aColorBL,aBlend);}},Uc:function(aClip,aBitmap,aFrameNr,aDstRect,Kq,aColorTL
...
,aColorBR,aColorBL,aBlend);}},VJ:function(aClip,aBitmap,aFrameNr,aDstX1,aDstY1,aDstW1
...
,aSrcRect,aColor1,aColor2,aColor3,aColor4,aBlend,aFilter);}},VG:function(aClip,aBitmap
...
,aFilter);}},Rp:function(aClip,aBitmap,aFrameNr,aDstRect,aSrcPos,aColorTL,aColorTR
...
,aColorBR,aColorBL,aBlend);}},MD:function(aClip,aDstRect,aColorTL,aColorTR,aColorBR
...
,aColorTR,aColorBR,aColorBL,aBlend);}},Uf:function(aClip,aDstPos1,aDstPos2,Y8,Y9
,aColor1,aColor2,aBlend){if(!this.bitmap)this.Update();if(!this.bitmap)return;var
G1=Y8;var G2=Y9;var FY=aDstPos1;var FZ=aDstPos2;if(B.z8(FY,FZ))return;if(G1<=1)G1=
1;if(G2<=1)G2=1;var HG=G1/2;var HH=G2/2;var Jm=FY[0];var Jn=FY[1];var Jo=FZ[0];var
Jp=FZ[1];var Dx=Jo-Jm;var Dy=Jp-Jn;var Cg=Math.sqrt((Dx*Dx)+(Dy*Dy));if(((G1>4096
)||(G2>4096))||(Cg>4096)){B.aa8("%s",Ig);return;}Dx=Dx/Cg;Dy=Dy/Cg;var x1=Jm+(Dy
*HG);var y1=Jn-(Dx*HG);var x2=Jo+(Dy*HH);var y2=Jp-(Dx*HH);var x3=Jo-(Dy*HH);var
y3=Jp+(Dx*HH);var x4=Jm-(Dy*HG);var y4=Jn+(Dx*HG);var TR=B.zW(B.abi.Kh);var srcRect=[
].concat(Kl,B.aaj(TR.FrameSize,Jc));var dstBitmap=this.bitmap;var dstFrameNo=this.
Eq;var srcBitmap=TR.bitmap;{B.aa9(dstBitmap,srcBitmap,dstFrameNo,0,aClip,x1,y1,1.0
,x2,y2,1.0,x3,y3,1.0,x4,y4,1.0,srcRect,aColor1,aColor2,aColor2,aColor1,aBlend,false
);}},Ue:function(aClip,aDstPos1,aDstPos2,aColor1,aColor2,aBlend){if(!this.bitmap
...
!=D))A._Mark(A._cycle=D);if((A=this.MR)&&((A=A[0])._cycle!=D))A._Mark(A._cycle=D
);},_className:"Graphics::Canvas"};C.R_={Um:1,Un:0,Uo:0,Uq:0,Ur:1,Us:0,MO:0,MP:0
,Ut:1,RM:0,LG:0,Zp:true,Mx:function(aX,Y_){var AaD=((aX*this.MO)+(Y_*this.MP))+this.
RM;this.LG=AaD;return true;},Ua:function(Nt,Nw,Nu,Nx,Qv,Qw,Nv,Ny){var LU=Nu-Qv;var
LW=Nx-Qw;var LV=Nv-Qv;var LX=Ny-Qw;var Mo=((Nt-Nu)+Qv)-Nv;var Mp=((Nw-Nx)+Qw)-Ny;
var Ji=(LU*LX)-(LW*LV);if(!Ji)return null;this.MO=((Mo*LX)-(Mp*LV))/Ji;this.MP=((
LU*Mp)-(LW*Mo))/Ji;this.Ut=0;this.RM=1;this.Um=(Nu-Nt)+(this.MO*Nu);this.Un=(Nv-
Nt)+(this.MP*Nv);this.Uo=Nt;this.Uq=(Nx-Nw)+(this.MO*Nx);this.Ur=(Ny-Nw)+(this.MP
*Ny);this.Us=Nw;this.Zp=false;return this;},_Init:function(aArg){this.__proto__=
C.R_;B.hJ++;},_Done:function(){this.__proto__=null;B.hJ--;},_ReInit:function(){}
,_Mark:function(D){var A;if((A=this.G)&&(A._cycle!=D))A._Mark(A._cycle=D);},G:null
,_cycle:0,_observers:null,_className:"Graphics::WarpMatrix"};C.AaV={Left:0x1,AbN:
0x2,Right:0x4,AaM:0x8,Aa7:0x10};
