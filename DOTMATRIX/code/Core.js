...
var Jc="View is not in this group";var Qb="No view to remove";var Qc="No view to add";
var Qd="View already in a group";var Qe="Recursive invalidate during active update cycle.";
var Km=[-8,-8,9,9];var Nh=[0,0,1,1];var Qf="The KeyPressHandler is embedded within an object not being derived "+
"from Core::Group.";var Qg="Trying to cancel a task not belonging to this queue!";
var Ni="Trying to enqueue a task twice!";
C.Cu={Aj:null,Au:null,L:null,A4:null,I:0x103,Dt:0x14,KD:function(Z,Kt){},Gt:function(
E){var A;var Cd=E^this.Dt;if(!Cd)return;this.Dt=E;if(!!this.A4&&!((this.I&0x400)===
...
},Bn:function(HA,Je){var A;if(((this.I&0x200)===0x200))HA=HA&~0x400;var QV=(this.
I&~Je)|HA;var Ik=QV^this.I;this.I=QV;if(!!this.L&&!!(Ik&0x14)){var SX=((this.I&0x14
)===0x14);if(SX&&!this.L.Dq)this.L.Dg(this);if(!SX&&(this.L.Dq===this))this.L.Dg(
this.L.Rt(this,0x14));}if(!!this.L&&!!(Ik&0x403))this.L.AA(this.GetExtent());if(((
!!this.A4&&!!this.L)&&((QV&0x400)===0x400))&&((Ik&0x1)===0x1)){this.I=this.I|0x800;
...
,KD:function(Z,Kt){var Y=B._NewObject(C.ML,0);this.A4=null;Y.Cf=this.getExtent();
Y.Ap=Z;Y.Iq=Kt;Y.HM=this.Ba;Y.HN=this.Bb;this.A4=Y;},KS:function(Z,CI){var A;var
AW=this.Dt;var Y=(C.ML.isPrototypeOf(A=this.A4)?A:null);var x1=Y.Cf[0];var y1=Y.
...
Y.Ap[1];if(C3[0]!==B5[0]){var By=((AW&0x4)===0x4);var Bz=((AW&0x8)===0x8);var DB=((
AW&0x1)===0x1);if(!By&&(DB||!Bz))x1=((x1*B5[0])/C3[0])|0;if(!Bz&&(DB||!By)){x2=x2-
Y.Ap[0];x2=((x2*B5[0])/C3[0])|0;x2=x2-B5[0];}else x2=x2-Y.Ap[2];x1=x1+Z[0];x2=x2+
Z[2];if(!DB){if(By&&!Bz)x2=x1+w;else if(!By&&Bz)x1=x2-w;else{x1=x1+((((x2-x1)-w)
/2)|0);x2=x1+w;}}}else{x2=x2-Y.Ap[2];x1=x1+Z[0];x2=x2+Z[2];}if(C3[1]!==B5[1]){var
BA=((AW&0x10)===0x10);var Bx=((AW&0x20)===0x20);var DC=((AW&0x2)===0x2);if(!BA&&(
DC||!Bx))y1=((y1*B5[1])/C3[1])|0;if(!Bx&&(DC||!BA)){y2=y2-Y.Ap[1];y2=((y2*B5[1])
/C3[1])|0;y2=y2-B5[1];}else y2=y2-Y.Ap[3];y1=y1+Z[1];y2=y2+Z[3];if(!DC){if(BA&&!
...
x2,y2];}else{this.BT([x1,y1]);this.BJ([x2,y2]);this.A4=Y;}return[w,h];},JZ:function(
...
Z,Kt){var Y=B._NewObject(C.MM,0);this.A4=null;Y.Cf=this.GetExtent();Y.Ap=Z;Y.Iq=
Kt;Y.HM=this.Ba;Y.HN=this.Bb;Y.Mk=this.CF;Y.Ml=this.Cl;this.A4=Y;},KS:function(Z
,CI){var A;var AW=this.Dt;var Y=(C.MM.isPrototypeOf(A=this.A4)?A:null);var x1=Y.
...
];y1=y1-Y.Ap[1];if(C3[0]!==B5[0]){var By=((AW&0x4)===0x4);var Bz=((AW&0x8)===0x8
);var DB=((AW&0x1)===0x1);if(!By&&(DB||!Bz))x1=((x1*B5[0])/C3[0])|0;if(!Bz&&(DB||
!By)){x2=x2-Y.Ap[0];x2=((x2*B5[0])/C3[0])|0;x2=x2-B5[0];}else x2=x2-Y.Ap[2];x1=x1+
...
B5[1]){var BA=((AW&0x10)===0x10);var Bx=((AW&0x20)===0x20);var DC=((AW&0x2)===0x2
);if(!BA&&(DC||!Bx))y1=((y1*B5[1])/C3[1])|0;if(!Bx&&(DC||!BA)){y2=y2-Y.Ap[1];y2=((
y2*B5[1])/C3[1])|0;y2=y2-B5[1];}else y2=y2-Y.Ap[3];y1=y1+Z[1];y2=y2+Z[3];if(!DC){
...
HE=Y.Cf[0];var HF=Y.Cf[1];var GU=(Y.Cf[2]-HE)-1;var GT=(Y.Cf[3]-HF)-1;if(!GU)GU=
1;if(!GT)GT=1;if(((this.I&0x100)===0x100)){this.Ba=[x1+((((Y.HM[0]-HE)*w)/GU)|0)
,y1+((((Y.HM[1]-HF)*h)/GT)|0)];this.Bb=[x1+((((Y.HN[0]-HE)*w)/GU)|0),y1+((((Y.HN[
1]-HF)*h)/GT)|0)];this.CF=[x1+((((Y.Mk[0]-HE)*w)/GU)|0),y1+((((Y.Mk[1]-HF)*h)/GT
)|0)];this.Cl=[x1+((((Y.Ml[0]-HE)*w)/GU)|0),y1+((((Y.Ml[1]-HF)*h)/GT)|0)];}else{
this.BT([x1+((((Y.HM[0]-HE)*w)/GU)|0),y1+((((Y.HM[1]-HF)*h)/GT)|0)]);this.BJ([x1+((((
Y.HN[0]-HE)*w)/GU)|0),y1+((((Y.HN[1]-HF)*h)/GT)|0)]);this.Ft([x1+((((Y.Mk[0]-HE)
*w)/GU)|0),y1+((((Y.Mk[1]-HF)*h)/GT)|0)]);this.Gu([x1+((((Y.Ml[0]-HE)*w)/GU)|0),
y1+((((Y.Ml[1]-HF)*h)/GT)|0)]);this.A4=Y;}return[w+1,h+1];},JZ:function(aOffset,
...
L.I=this.L.I|0x4000;B.ow([A=this.L,A.CP],this);}},O0:function(CX){var Bv=B.aan(4
,B.vw,null);var i=0;var j=3;var QO=false;var QP=false;Bv.Set(0,this.Ba);Bv.Set(1
,this.Bb);Bv.Set(2,this.CF);Bv.Set(3,this.Cl);while(i<4){var T3=Bv.Get(i)[0];var
Ol=Bv.Get(i)[1];var AaC=Bv.Get(j)[0];var Rd=Bv.Get(j)[1];if(((Ol>CX[1])!==(Rd>CX[
1]))||((Ol<CX[1])!==(Rd<CX[1]))){var x=((((AaC-T3)*(CX[1]-Ol))/(Rd-Ol))|0)+T3;if(
CX[0]>x)QO=!QO;if(CX[0]<x)QP=!QP;}j=i;i=i+1;}return QO||QP;},Ui:function(){return((((
...
C.B1={R:B.vx,KD:function(Z,Kt){var Y=B._NewObject(C.JV,0);Y.Cf=this.R;Y.Ap=Z;Y.Iq=
Kt;this.A4=Y;},KS:function(Z,CI){var A;var AW=this.Dt;var Y=this.A4;var x1=Y.Cf[
...
y1-Y.Ap[1];if(C3[0]!==B5[0]){var By=((AW&0x4)===0x4);var Bz=((AW&0x8)===0x8);var
DB=((AW&0x1)===0x1);if(!By&&(DB||!Bz))x1=((x1*B5[0])/C3[0])|0;if(!Bz&&(DB||!By)){
x2=x2-Y.Ap[0];x2=((x2*B5[0])/C3[0])|0;x2=x2-B5[0];}else x2=x2-Y.Ap[2];x1=x1+Z[0];
x2=x2+Z[2];if(!DB){if(By&&!Bz)x2=x1+w;else if(!By&&Bz)x1=x2-w;else{x1=x1+((((x2-
x1)-w)/2)|0);x2=x1+w;}}}else{x2=x2-Y.Ap[2];x1=x1+Z[0];x2=x2+Z[2];}if(C3[1]!==B5[
...
this,aArg);this.__proto__=C.B1;},_className:"Core::RectView"};C.O={AV:null,Bl:null
,N0:null,BK:null,BN:null,EJ:null,JF:null,Dq:null,Hd:255,Ai:function(aArg){this.C5(
);},DY:function(Bd,aClip,aOffset,A1,aBlend){var A;A1=((A1+1)*this.Hd)>>8;aBlend=
aBlend&&((this.I&0x2)===0x2);if(!this.BK||(Bd.A3===this))this.SV(Bd,aClip,B.aak(
aOffset,this.R.slice(0,2)),A1,aBlend);else{var BL=255|(255<<8)|(255<<16)|((A1&0xFF
)<<24);this.BK.Update();Bd.Rp(aClip,this.BK,0,B.aam(this.R,aOffset),A9,BL,BL,BL,
...
0x10000)||((this.BN.A3===P)&&!Js))){var Cf=P.GetExtent();var NL=FC;var Jh=null;if(
NL===P)NL=null;if(((P.I&0x400)===0x400)){if(!(((A=B.kz(Cf,X))[0]>=A[2])||(A[1]>=
A[3])))Jh=P.Fm(X,Ac,C_,NL,FG,FF);}else if(!(((A=B.kz(Cf,Ay))[0]>=A[2])||(A[1]>=A[
3]))||(FC===P))Jh=P.Fm(Ay,Ac,C_,NL,FG,FF);P=P.Au;if(!!Jh){if(!Jl||((Jh.KV<Jl.KV)&&(
Jh.KV>=0)))Jl=Jh;if(!Jh.KV)P=null;}}else P=P.Au;FG=null;}return Jl;},KR:function(
Ay){var A;var Ag;var P=this.AV;var LS=Bc;var Mi=true;var result=(Ay=Ag=B.aal(Ay,
this.R.slice(0,2)),Ag);while(!!P){if(((P.I&0x200)===0x200)){var Mh=(C.Lw.isPrototypeOf(
P)?P:null);LS=B.kz(Ay,Mh.R);Mi=((Mh.I&0x1)===0x1);}if(((P.I&0x1)===0x1)){if(((P.
I&0x400)===0x400)){if(Mi){var X=B.kz(P.GetExtent(),LS);if(!((X[0]>=X[2])||(X[1]>=
...
result,this.R.slice(0,2)),this.R);},Bn:function(HA,Je){var A;var Zy=this.I;C.B1.
Bn.call(this,HA,Je);var Ik=this.I^Zy;if(!!this.Dq&&((Ik&0x40)===0x40)){if(((this.
...
R)[2]-A[0],A[3]-A[1]];var N2=[E[2]-E[0],E[3]-E[1]];var JI=!B.z8(Ip,N2);if(JI&&!!
this.BK){this.BK.Lo(N2);B.vv(this,0);B.vv(this.BK,0);}C.B1.H.call(this,E);if((JI&&(
...
I|0x5000;B.ow([this,this.CP],this);}},TT:function(AG){var S$=(C.KeyEvent.isPrototypeOf(
AG)?AG:null);var Fe=this.N0;if(!S$)return null;while(!!Fe&&(!Fe.Bo||!Fe.BI(S$)))
Fe=Fe.Aj;return Fe;},Aay:function(M){if(!!this.BK){this.BK.A3=this;var X=B.aal(this.
KR(B.aam(this.BK.Es,this.R.slice(0,2))),this.R.slice(0,2));this.BK.MD(X,X,0x00000000
,0x00000000,0x00000000,0x00000000,false);this.SV(this.BK,X,A9,255,true);this.BK.
A3=null;}},SV:function(Bd,aClip,aOffset,A1,aBlend){var A;var P=this.AV;var LS=Bc;
var Mi=true;this.Ub(Bd,aClip,aOffset,A1,aBlend);while(!!P){if(((P.I&0x200)===0x200
)){var Mh=(C.Lw.isPrototypeOf(P)?P:null);LS=B.kz(aClip,B.aam(Mh.R,aOffset));Mi=((
Mh.I&0x1)===0x1);}if(((P.I&0x1)===0x1)){if(((P.I&0x400)===0x400)){if(Mi){var X=B.
...
2])||(X[1]>=X[3])))P.DY(Bd,X,aOffset,A1,aBlend);}}P=P.Aj;}this.Ud(Bd,aClip,aOffset
,A1,aBlend);},Aak:function(){var A;var QM=((this.I&0x1000)===0x1000);var HI=[0,0
,(A=this.R)[2]-A[0],A[3]-A[1]];var GV=false;var KB=Bc;var QK=Bc;var P=this.Bl;var
DR=null;while(!!P){if(((P.I&0x800)===0x800)){GV=true;P.I=P.I&~0x800;}if(GV&&((P.
I&0x200)===0x200))GV=false;P=P.Au;}GV=false;P=this.AV;if(QM){this.I=this.I&~0x1000;
QM=!((HI[0]>=HI[2])||(HI[1]>=HI[3]));}this.I=this.I|0x2000;while(!!P){if(((P.I&0x400
)===0x400)){if(!!P.A4&&(P.A4.Iq!==DR))P.A4=null;if((!P.A4&&GV)&&(P.Dt!==0x14))P.
KD(QK,DR);}if(!!P.A4){if(QM&&!((P.I&0x400)===0x400))P.KS(HI,0);if(GV&&((P.I&0x400
)===0x400))P.KS(QK,0);}if(((P.I&0x200)===0x200)){GV=((P.I&0x1000)===0x1000);DR=(
C.Lw.isPrototypeOf(P)?P:null);if(GV){P.I=P.I&~0x1000;KB=DR.R;QK=KB;GV=!((KB[0]>=
KB[2])||(KB[1]>=KB[3]));}if(GV)this.AA(DR.R);}P=P.Aj;}this.I=this.I&~0x2000;this.
R7([HI[2]-HI[0],HI[3]-HI[1]]);},CP:function(M){var A;var AaA=((this.I&0x1000)===
0x1000);if(((this.I&0x4000)===0x4000)){this.I=this.I&~0x4000;this.Aak();}if(((this.
I&0x8000)===0x8000)||AaA){this.I=this.I&~0x8000;this.Hy(this.I);}},Dg:function(E
...
BK.MR=[this,this.Aay];}else{this.BK.MR=null;this.BK.Lo(A9);this.BK=null;}if(!!this.
...
this.R);},PB:function(){var A;return((this.I&0x1)===0x1);},U:function(E){if(E)this.
Bn(0x1,0x0);else this.Bn(0x0,0x1);},Ud:function(Bd,aClip,aOffset,A1,aBlend){},Ub:
function(Bd,aClip,aOffset,A1,aBlend){},GetMinimalSize:function(){return A9;},P2:
function(Cm,D6,Hz,FD,FE,LN,Fb,GO,D5,D3,D4){var A;if(!this.BN){this.VD(Cm,D6,Hz,FD
,FE,null,null,D5,D3,D4);return;}var Io=this.BN;var Cs=Io.Aj;if(((Cm.I&0x10000)===
0x10000)&&(this.BN.A3!==Cm))throw new Error(DL);var FU=B._NewObject(C.OD,0);var DQ=
...
Cm.Bn(0x10000,0x0);if(!!CA){this.Dp(Cs.A3,CA.My(),null,null,D4);this.Dp(Io.A3,DQ.
HV(),null,null,true);this.Dp(FU.A3,D6.HW(),D5,D3,true);}else if(!!DW){this.Dp(Cs.
A3,DW.Mz(),null,null,D4);this.Dp(Io.A3,DQ.HV(),null,null,true);this.Dp(FU.A3,D6.
HW(),D5,D3,true);}else if(!!DQ){this.Dp(Io.A3,DQ.HV(),null,null,D4);this.Dp(FU.A3
,D6.HW(),D5,D3,true);}else this.Dp(FU.A3,D6.HW(),D5,D3,D4);},Rr:function(Cm,LN,Fb
,GO,D5,D3,D4){var A;if(!this.BN)return;if(!Cm)return;var Ce=this.BN;var Cs=this.
BN.Aj;var KH=null;while((!!Ce&&(Ce.A3!==Cm))&&!!Ce.Aj){KH=Ce;Ce=Cs;Cs=Ce.Aj;}if(
!Ce||(Ce.A3!==Cm))throw new Error(FA);if(!KH){this.BN=Cs;Ce.Aj=null;}else{KH.Aj=
Cs;Ce.Aj=null;}Ce.A3.Bn(0x0,0x10040);if(((((this.I&0x40)===0x40)&&!!Cs)&&!KH)&&((
Cs.A3.I&0x4)===0x4))Cs.A3.Bn(0x40,0x0);var DQ=Ce.DQ;var DW=null;var CA=null;if(!
!Cs)DW=Cs.DW;if(!!Cs&&!!Ce.JE)DW=Ce.JE;if(!!Cs&&!!GO)DW=GO;if(!!KH&&!!Cs)CA=Cs.CA;
if((!!KH&&!!Cs)&&!!Fb)CA=Fb;if(!!LN)DQ=LN;if(!!CA){this.Dp(Cs.A3,CA.My(),null,null
,D4);this.Dp(Ce.A3,DQ.HV(),D5,D3,true);}else if(!!DW){this.Dp(Cs.A3,DW.Mz(),null
,null,D4);this.Dp(Ce.A3,DQ.HV(),D5,D3,true);}else this.Dp(Ce.A3,DQ.HV(),D5,D3,D4
);},VD:function(Cm,D6,Hz,FD,FE,Fb,GO,D5,D3,D4){var A;if(!Cm)return;if(!!this.BN&&(
this.BN.A3===Cm)){this.P2(Cm,D6,Hz,FD,FE,null,Fb,GO,D5,D3,D4);return;}if(((Cm.I&
0x10000)===0x10000))throw new Error(DL);var Ce=B._NewObject(C.OD,0);if(!!this.BN&&
...
FD;if(!FD)FD=FE;Ce.DQ=Hz;Ce.CA=FD;Ce.DW=FE;Ce.JE=GO;if(this.Dq===Cm)this.Dg(null
);if(!!this.BN)this.BN.A3.Bn(0x0,0x40);if(((this.I&0x40)===0x40)&&((Cm.I&0x4)===
0x4))Cm.Bn(0x10040,0x0);else Cm.Bn(0x10000,0x0);Ce.A3=Cm;Ce.Aj=this.BN;this.BN=Ce;
if(!!CA){this.Dp(this.BN.Aj.A3,CA.My(),null,null,D4);this.Dp(Cm,D6.HW(),D5,D3,true
);}else this.Dp(Cm,D6.HW(),D5,D3,D4);},Pn:function(){var A;if(((this.I&0x40)===0x40
))return;if(((this.I&0x80)===0x80))return;if(((this.I&0x10000)===0x10000)){if(!!
this.L)this.L.Pn();return;}if(!!this.L&&(this.L.Dq!==this))this.L.Dg(this);if(!!
this.L)this.L.Pn();},Uj:function(Dv){var A;return(A=Dv)&&((this.I&A)===A);},RL:function(
...
AG);else if(!BE&&!!P)BE=P.BI(AG);if(!BE)BE=this.BI(AG);if(!BE)BE=this.TT(AG);return BE;
},BroadcastEventAtPosition:function(AG,SN,aFilter){var A;var P=this.Bl;var BE=null;
while(!!P&&!BE){if((!aFilter||((A=aFilter)&&((P.I&A)===A)))&&B.vt(P.GetExtent(),
SN)){var As=(C.O.isPrototypeOf(P)?P:null);if(!!As)BE=As.BroadcastEventAtPosition(
AG,B.aaj(SN,As.R.slice(0,2)),aFilter);else BE=P.BI(AG);}P=P.Au;}if(!BE)BE=this.BI(
...
!BE)BE=this.BI(AG);if(!BE)BE=this.TT(AG);return BE;},R7:function(aSize){},Hy:function(
...
if(!As.L&&(As!==this)){As.AA(Ay);return;}if(!!Kw){var Zw=Kw.Es;Kw.Es=B.vS(Kw.Es,
Ay);if(!B.z9(Zw,Kw.Es)){B.vv(As,0);B.vv(Kw,0);}}if(!((As.I&0x1)===0x1))return;Ay=
B.kz(B.aam(Ay,As.R.slice(0,2)),As.R);As=As.L;}},Rt:function(Ad,aFilter){var A;if(
!Ad||(Ad.L!==this))return null;var In=Ad.Aj;var Is=Ad.Au;var L9=0x10000;if(((aFilter&
0x10000)===0x10000))L9=0x0;while(!!In||!!Is){if((!!In&&(!aFilter||((A=aFilter)&&((
In.I&A)===A))))&&(!L9||!((A=L9)&&((In.I&A)===A))))return In;if((!!Is&&(!aFilter||((
A=aFilter)&&((Is.I&A)===A))))&&(!L9||!((A=L9)&&((Is.I&A)===A))))return Is;if(!!In
...
C.P4,0);Bg.L=this;Bg.O=GM;Bg.N4=D3;Bg.QY=D5;if(!!GM.JF)GM.JF.Dj.VF(GM.JF);GM.JF=
Bg;GM.I=GM.I|0x20000;if((D4&&!!this.EJ.Bl)&&!this.EJ.Bl.OZ())(B.abl.MC.isPrototypeOf(
A=this.EJ.Bl)?A:null).Rk(Bg);else{var Dj=B._NewObject(B.abl.MC,0);Dj.Rk(Bg);this.
EJ.R3(Dj,false);}},Lz:function(Ad){var A;if(!Ad)throw new Error(Kl);if(Ad.L!==this
...
Qb);if(Ad.L!==this)throw new Error(Jc);if((((Ad.I&0x401)===0x401)&&!!Ad.Au)&&!!Ad.
...
,this.CP],this);}Ad.A4=null;if(this.Dq===Ad)this.Dg(this.Rt(Ad,0x14));if(!!Ad.Au
...
AA(Ad.GetExtent());},K:function(Ad,Ks){var A;if(!Ad)throw new Error(Qc);if(!!Ad.
L)throw new Error(Qd);var HB=null;if((Ks<0)&&!!this.Bl){HB=this.Bl;Ks=Ks+1;}while(((
...
A._cycle=D);if((A=this.Bl)&&(A._cycle!=D))A._Mark(A._cycle=D);if((A=this.N0)&&(A.
...
,A7:B.aan(10,null,null),Kx:null,HD:null,Mr:0,BM:0,CJ:B.aan(10,0,null),NJ:B.aan(10
...
,null),AT:0,NX:0,NW:0,Dd:B.aan(4,0,null),B8:B.aan(4,B.vx,null),B7:0,L4:0,KE:0,QN:
...
B.mr;if(!fullScreenUpdate)Bd.MD(aClip,B.aam(B.aam(aClip,aOffset),this.R.slice(0,
...
E){var A;var Zv=this.BK;C.O.Lj.call(this,E);if(((Zv!==this.BK)&&!this.L)&&((this.
I&0x1)===0x1))this.AA([0,0,(A=this.R)[2]-A[0],A[3]-A[1]]);},Ls:function(E){var A;
var Zz=this.Hd;C.O.Ls.call(this,E);if(((Zz!==this.Hd)&&!this.L)&&((this.I&0x1)===
...
);this.BM=0;return BE;},AA:function(Ay){var A;if(this.Mr>0)throw new Error(Qe);if(
...
Dd.Set(i,B.zS(this.B8.Get(i)));return;}if(this.B7<3){this.B8.Set(this.B7,Ay);this.
Dd.Set(this.B7,B.zS(Ay));this.B7=this.B7+1;return;}var j;var DS;var L3=0;var L5=
0;var SP=2147483647;this.B8.Set(this.B7,Ay);this.Dd.Set(this.B7,B.zS(Ay));for(j=
0;j<=this.B7;j=j+1)for(DS=j+1;DS<=this.B7;DS=DS+1){var Oh=B.zS(B.vS(this.B8.Get(
j),this.B8.Get(DS)));var TS=((Oh<<8)/(this.Dd.Get(j)+this.Dd.Get(DS)))|0;if(TS<SP
){SP=TS;L3=j;L5=DS;}}this.B8.Set(L3,B.vS(this.B8.Get(L3),this.B8.Get(L5)));this.
Dd.Set(L3,B.zS(this.B8.Get(L3)));if(L5!==this.B7){this.B8.Set(L5,this.B8.Get(this.
B7));this.Dd.Set(L5,this.Dd.Get(this.B7));}},Zj:function(){var CM=B._NewObject(C.
...
},Zk:function(M){var i;var Jl=false;for(i=0;i<10;i=i+1)if(!!this.A7.Get(i)){var pos=
...
0;var SY=0;ticksCount=((new Date).getTime()-B.vs)|0;if(!!this.NX&&(ticksCount>this.
NX))SY=((this.NW*1000)/((ticksCount-this.NX)|0))|0;this.NW=0;this.NX=ticksCount;
return SY;},Update:function(){var A;if(!this.Kx)this.Kx=B._NewObject(B.Graphics.
...
this.B7>0){this.NW=this.NW+1;this.B7=0;}},UpdateCanvas:function(Bd,aOffset){var A;
var G3=Bc;var Ze=[].concat(aOffset,B.aak(Bd.FrameSize,aOffset));var i;var j=this.
B7;this.Mr=this.Mr+1;Bd.A3=this;for(i=0;(i<j)&&(i<4);i=i+1)if(this.Dd.Get(i)>0){
this.DY(Bd,B.aal(this.B8.Get(i),aOffset),[-aOffset[0],-aOffset[1]],255,true);G3=
B.vS(G3,B.kz(Ze,this.B8.Get(i)));}else j=j+1;Bd.A3=null;this.Mr=this.Mr-1;if(!((
G3[0]>=G3[2])||(G3[1]>=G3[3])))return B.aal(G3,aOffset);else return G3;},GetUpdateRegion:
function(Ns){var i;var j=this.B7;if(Ns<0)return Bc;for(i=0;(i<j)&&(i<4);i=i+1)if(
!this.Dd.Get(i)){j=j+1;Ns=Ns+1;}else if(i===Ns)return this.B8.Get(i);return Bc;}
,BeginUpdate:function(){var A;var i;if(!!this.B7&&!B.z9(this.B8.Get(0),[0,0,(A=this.
R)[2]-A[0],A[3]-A[1]])){var T1=B.aan(3,B.vx,null);var T0=this.B7;for(i=0;i<T0;i++
)T1.Set(i,this.B8.Get(i));for(i=0;i<T0;i++){var TU=B.aam(T1.Get(i),this.R.slice(
0,2));var TW=this.KR(TU);if(!B.z9(TU,TW))this.AA(B.aal(TW,this.R.slice(0,2)));}}
var j;var DS;for(j=0;j<(this.B7-1);j++)if(this.Dd.Get(j)>0)for(DS=j+1;DS<this.B7;
DS++)if(this.Dd.Get(DS)>0){var Oh=B.zS(B.vS(this.B8.Get(j),this.B8.Get(DS)));if(((
Oh-this.Dd.Get(j))-this.Dd.Get(DS))<0){this.B8.Set(j,B.vS(this.B8.Get(j),this.B8.
Get(DS)));this.Dd.Set(j,Oh);this.Dd.Set(DS,0);}}for(i=this.B7-1;i>=0;i--)if(!this.
Dd.Get(i))this.B7=this.B7-1;return this.B7;},DoesNeedUpdate:function(){if(this.B7>
0)return true;return false;},Initialize:function(aSize){this.H([].concat(A9,aSize
));if(this.QN)this.I=this.I|0x60;else this.I=this.I|0x20;this.AA(this.R);return this;
},SetRootFocus:function(Qr){if(Qr===this.QN)return false;this.QN=Qr;if(!Qr)this.
Bn(0x0,0x40);else this.Bn(0x40,0x0);return true;},SetUserInputTimestamp:function(
Y7){this.BM=Y7;},DriveKeyboardHitting:function(Cb,LJ,E$){var A;var Q8=!!this.DT;
if(!!this.DT&&((!E$||(this.L4!==Cb))||(this.KE!==LJ))){var CM=null;var P=(C.Cu.isPrototypeOf(
A=this.DT)?A:null);var Fe=(C.Cj.isPrototypeOf(A=this.DT)?A:null);if(!!this.L4)CM=
B._NewObject(C.KeyEvent,0).Initialize(this.L4,false);if(this.KE!==0x00)CM=B._NewObject(
C.KeyEvent,0).Initialize2(this.KE,false);if(!!Fe)Fe.BI(CM);else if(!!P)P.BI(CM);
this.L4=0;this.KE=0x00;this.DT=null;}if(!!this.DT){var CM=null;var P=(C.Cu.isPrototypeOf(
A=this.DT)?A:null);var Fe=(C.Cj.isPrototypeOf(A=this.DT)?A:null);if(!!Cb)CM=B._NewObject(
C.KeyEvent,0).Initialize(Cb,true);if(this.KE!==0x00)CM=B._NewObject(C.KeyEvent,0
).Initialize2(LJ,true);if(!!Fe)Fe.BI(CM);else if(!!P)P.BI(CM);}if(!this.DT&&E$){
if(!!Cb)this.DT=this.DispatchEvent(B._NewObject(C.KeyEvent,0).Initialize(Cb,true
...
DT)?A:null))this.DT=null;this.L4=Cb;this.KE=LJ;Q8=Q8||!!this.DT;}this.BM=0;return Q8;
...
}var Bm=B.aaj(Cc,this.DP.Get(Ac));this.DP.Set(Ac,Cc);if(!this.A7.Get(Ac)||B.z8(Bm
,A9)){this.BM=0;return false;}var pos=Cc;var As=this.A7.Get(Ac).L;while(!!As&&(As
...
Ac,this.CJ.Get(Ac)+1,false,tmp,Cc),0x18);}else{this.HC.Set(Ac,pos);this.AT=Ac;this.
A7.Get(Ac).BI(this.Zj().Initialize(Ac,pos,this.GS.Get(Ac),Bm,this.EI.Get(Ac),this.
CJ.Get(Ac)+1,this.EH.Get(Ac),Cc,this.FI.Get(Ac)));}this.BM=0;return true;},DriveCursorHitting:
function(E$,Ac,Cc){return this.DriveMultiTouchHitting(E$,Ac,Cc);},DriveMultiTouchHitting:
function(E$,Ac,Cc){if((Ac<0)||(Ac>9)){this.BM=0;return false;}var ticksCount=this.
BM;if(!ticksCount)ticksCount=((new Date).getTime()-B.vs)|0;var Aaq=this.BM;this.
DriveMultiTouchMovement(Ac,Cc);Cc=this.DP.Get(Ac);this.BM=Aaq;if(E$)this.FI.Set(
Ac,Cc);if(E$&&!this.A7.Get(Ac)){var B6;var pos=Cc;if(B.vt(this.NJ.Get(Ac),Cc)&&((
ticksCount-this.Kz.Get(Ac))<=250))this.CJ.Set(Ac,this.CJ.Get(Ac)+1);else this.CJ.
Set(Ac,0);this.NJ.Set(Ac,B.aam(Km,Cc));this.Kz.Set(Ac,ticksCount);B6=this.Fm(B.aam(
Km,Cc),Ac,this.CJ.Get(Ac)+1,null,null,0x0);if(!!B6){this.BroadcastEvent(this.Ky(
).InitializeDown(Ac,this.CJ.Get(Ac)+1,false,B6.Cu,Cc),0x18);this.A7.Set(Ac,B6.Cu
);this.EH.Set(Ac,B6.AN);}else{this.A7.Set(Ac,null);this.EH.Set(Ac,A9);this.BM=0;
return false;}var As=B6.Cu.L;while(!!As&&(As!==this)){pos=B.aaj(pos,As.R.slice(0
...
Ac)+1,this.EH.Get(Ac),false,Cc));this.BM=0;return true;}if(!E$&&!!this.A7.Get(Ac
)){var pos=Cc;var As=this.A7.Get(Ac).L;while(!!As&&(As!==this)){pos=B.aaj(pos,As.
...
EI.Get(Ac),this.CJ.Get(Ac)+1,this.EH.Get(Ac),false,Cc,this.FI.Get(Ac)));this.BroadcastEvent(
this.Ky().InitializeUp(Ac,this.CJ.Get(Ac)+1,false,tmp,Cc),0x18);this.BM=0;return true;
}this.BM=0;return false;},PY:function(GN,SM,FG,FF){if(GN===this)GN=null;if(!this.
A7.Get(this.AT))return;var B6;B6=this.Fm(B.aam(Km,this.DP.Get(this.AT)),this.AT,
1,GN,FG,FF);if(!!B6&&(this.A7.Get(this.AT)!==B6.Cu))this.OB(B6.Cu,B6.AN);if(!B6&&(
this.A7.Get(this.AT)!==SM))this.OB(SM,A9);},OB:function(GN,EE){if(!this.A7.Get(this.
...
]).__proto__=C.Root.CJ;(this.NJ=[]).__proto__=C.Root.NJ;(this.EI=[]).__proto__=C.
...
B8=[]).__proto__=C.Root.B8;this.__proto__=C.Root;this.I=0x7F;this.HD.DZ(10);this.
HD.CE=[this,this.Zk];this.Ai(aArg);},_Done:function(){this.__proto__=C.O;this.HD.
...
};C.Event={AF:0,K_:false,Ai:function(aArg){this.AF=this.MG();},MG:function(){var
...
"Core::Event"};C.KeyEvent={BB:0,AD:0,Down:false,Initialize2:function(Cb,E$){this.
BB=0;this.AD=Cb;this.Down=E$;if((Cb>=0x30)&&(Cb<=0x39))this.BB=(10+Cb)-48;if((Cb>=
0x41)&&(Cb<=0x5A))this.BB=(105+Cb)-65;if((Cb>=0x61)&&(Cb<=0x7A))this.BB=(105+Cb)-
97;if(Cb===0x20)this.BB=131;if(!this.BB)switch(Cb){case 0x2B:this.BB=132;break;case
...
function(Cb,E$){this.BB=Cb;this.Down=E$;this.AD=0x00;var QA=Cb-10;var Qz=Cb-105;
if((QA>=0)&&(QA<=9))this.AD=(48+QA)&0xFFFF;if((Qz>=0)&&(Qz<=25))this.AD=(65+Qz)&
...
},Ul:function(SL){switch(SL){case 141:return((this.AD>=0x41)&&(this.AD<=0x5A))||((
...
return(this.AD!==0x00)||!!this.BB;default:;}return SL===this.BB;},_Init:function(
aArg){C.Event._Init.call(this,aArg);this.__proto__=C.KeyEvent;},_className:"Core::KeyEvent"
};C.KT={LE:null,Cy:B.vw,CV:0,BR:0,Down:false,Dm:false,InitializeUp:function(Ac,C_
,Jd,Qt,Fa){this.Down=false;this.BR=Ac;this.CV=C_;this.Cy=Fa;this.LE=Qt;this.Dm=Jd;
return this;},InitializeDown:function(Ac,C_,Jd,Qt,Fa){this.Down=true;this.BR=Ac;
this.CV=C_;this.Cy=Fa;this.LE=Qt;this.Dm=Jd;return this;},_Init:function(aArg){C.
...
"Core::CursorGrabEvent"};C.Gh={G_:B.vw,Cy:B.vw,CV:0,B0:0,C4:B.vw,BU:B.vw,BR:0,Down:
false,Dm:false,InitializeHold:function(Ac,Ih,LL,LM,C_,EE,Fa,LK){this.Down=true;this.
BR=Ac;this.BU=B.aak(Ih,EE);this.C4=B.aak(LL,EE);this.B0=LM;this.CV=C_;this.Cy=Fa;
this.G_=LK;return this;},InitializeUp:function(Ac,Ih,LL,LM,C_,EE,Jd,Fa,LK){this.
Down=false;this.BR=Ac;this.BU=B.aak(Ih,EE);this.C4=B.aak(LL,EE);this.B0=LM;this.
CV=C_;this.Dm=Jd;this.Cy=Fa;this.G_=LK;return this;},InitializeDown:function(Ac,
Ih,C_,EE,Jd,Fa){this.Down=true;this.BR=Ac;this.BU=B.aak(Ih,EE);this.C4=B.aak(Ih,
EE);this.B0=0;this.CV=C_;this.Dm=Jd;this.Cy=Fa;this.G_=Fa;return this;},_Init:function(
aArg){C.Event._Init.call(this,aArg);this.__proto__=C.Gh;},_className:"Core::CursorEvent"
};C.JS={G_:B.vw,Cy:B.vw,CV:0,B0:0,AN:B.vw,C4:B.vw,BU:B.vw,BR:0,Initialize:function(
Ac,Ih,LL,aOffset,LM,Y6,EE,Fa,LK){this.BR=Ac;this.BU=B.aak(Ih,EE);this.C4=B.aak(LL
,EE);this.AN=aOffset;this.B0=LM;this.CV=Y6;this.Cy=Fa;this.G_=LK;return this;},_Init:
...
this.R))return;var Ip=[(A=this.R)[2]-A[0],A[3]-A[1]];var N2=[E[2]-E[0],E[3]-E[1]
];var JI=!B.z8(Ip,N2);var Bm=B.aaj(E.slice(0,2),this.R.slice(0,2));if(!B.z8(Bm,A9
...
,this);}P=P.Aj;}}C.B1.H.call(this,E);if(!!this.L&&JI){this.I=this.I|0x1000;if(!((
this.L.I&0x2000)===0x2000)){this.L.I=this.L.I|0x4000;B.ow([A=this.L,A.CP],this);
}}},_Init:function(aArg){C.B1._Init.call(this,aArg);this.__proto__=C.Lw;this.I=0x203;
},_className:"Core::Outline"};C.B2={Pp:null,Lh:null,Ld:null,EZ:null,Ck:null,BS:null
,Og:0,Aq:0,BR:0,AF:0,CV:0,B0:0,AN:B.vw,C4:B.vw,BU:B.vw,LA:8,Hg:0,RO:1,Down:false
,EV:false,Dm:false,QI:false,L6:0,DY:function(Bd,aClip,aOffset,A1,aBlend){},BI:function(
AG){var A;var Ab=(C.Gh.isPrototypeOf(AG)?AG:null);var AJ=(C.JS.isPrototypeOf(AG)?
AG:null);var NZ=this.EV;var Fh;var Ef;var Mq;var CO;var LY;if(!Ab&&!AJ)return null;
Fh=(!!Ab&&Ab.Down)&&!Ab.B0;Ef=(!!Ab&&Ab.Down)&&(Ab.B0>0);Mq=(!!Ab&&Ab.Down)&&(Ab.
B0>this.L6);CO=!!Ab&&!Ab.Down;LY=!!AJ;if(Fh)this.L6=((A=(Ab.Dm?0:50))&0x80)?A|0xFFFFFF00:
...
),this.L.RL(BO.Cy))){this.Og=0x20;this.Aq=this.Aq|67108864;return null;}}if(Fh){
var Ju=0;var FR;this.Aq=this.Aq|(1<<Ab.BR);for(FR=this.Aq&4095;FR>0;FR=FR>>1)if(
!!(FR&1))Ju=Ju+1;if(Ju===1)this.Aq=(this.Aq|16777216)|(4096<<Ab.BR);}if(CO&&(this.
Aq<16777216)){var DD=this.II();var B6=null;if(!!DD){var Q$=(!!this.Au?this.Au:this.
L);B6=DD.Fm(B.aam(Nh,Ab.Cy),Ab.BR,Ab.CV,null,Q$,0x0);}if(!!B6){var i;for(i=0;i<10;
i++)if(!!(this.Aq&(1<<i)))B6.Cu.BI(B._NewObject(C.Gh,0).InitializeDown(i,Ab.BU,Ab.
CV,A9,true,Ab.Cy));for(i=0;i<10;i++)if(!!(this.Aq&(1<<i)))B6.Cu.BI(B._NewObject(
C.Gh,0).InitializeUp(i,Ab.BU,Ab.BU,0,Ab.CV,A9,false,Ab.Cy,Ab.Cy));}}if(CO)this.Aq=(
this.Aq&~(1<<Ab.BR))|33554432;if(Mq&&(this.Aq<16777216))this.Aq=this.Aq|67108864;
if(CO&&Ab.Dm)this.Aq=this.Aq|67108864;if(CO&&!(this.Aq&4095))this.Og=0x0;if(CO&&
!(this.Aq&16777215))this.Aq=0;if(Ef&&(this.Aq>=67108864)){var DD=this.II();if(!!
DD)DD.PY(null,null,this,this.Og);}if((Ef&&!!(this.Aq&16777216))&&!!(this.Aq&33554432
)){Ef=false;CO=true;}if(!!Ab&&!(this.Aq&(4096<<Ab.BR)))return this;if(!!AJ&&!(this.
Aq&(4096<<AJ.BR)))return this;if(CO&&!(this.Aq&16777216))return this;if(((Fh||LY
...
EV=this.O0(Ab.BU);this.C4=Ab.C4;this.BU=Ab.BU;this.AN=A9;this.B0=Ab.B0;this.CV=Ab.
CV;this.Dm=Ab.Dm;this.BR=Ab.BR;this.AF=Ab.AF;if(Ab.Down&&!Ab.B0)NZ=false;}if(!!AJ
){this.Down=true;this.EV=this.O0(AJ.BU);this.C4=AJ.C4;this.BU=AJ.BU;this.AN=AJ.AN;
this.B0=AJ.B0;this.CV=AJ.CV;this.BR=AJ.BR;this.Dm=false;this.AF=AJ.AF;}var QG=this.
Down;if(!!AJ)(A=this.Pp)?A[1].call(A[0],this):null;if((!!Ab&&this.Down)&&!this.B0
)(A=this.BS)?A[1].call(A[0],this):null;if((!!Ab&&this.Down)&&(this.B0>0))(A=this.
EZ)?A[1].call(A[0],this):null;if((this.Down&&this.EV)&&!NZ){this.QI=true;(A=this.
Ld)?A[1].call(A[0],this):null;}if(this.QI&&(((QG&&!this.EV)&&NZ)||((!QG&&this.EV
)&&NZ))){this.QI=false;(A=this.Lh)?A[1].call(A[0],this):null;}if(!!Ab&&!QG)(A=this.
Ck)?A[1].call(A[0],this):null;if(!!this.Hg){var It=0x0;if(((((this.Hg&0x10)===0x10
)&&!!Ab)&&Ab.Down)&&(Ab.B0>=1000))It=0x10;if((((this.Hg&0x1)===0x1)&&!!AJ)&&((AJ.
...
)It=0x8;if(!!It){var DD=this.II();if(!!DD){this.Og=It;DD.PY(null,this,this,It);}
}}return this;},Fm:function(Ay,Ac,C_,FC,FG,FF){var A;if(!!FC&&(FC!==this))return null;
if((C_<1)||(C_>this.RO))return null;if(this.Aq>=33554432)return null;if((this.Aq>=
16777216)&&!(this.Aq&(4096<<Ac)))return null;if(!!(FF&this.Hg))return null;if(this.
Ui()){var Az=B.kz(Ay,this.GetExtent());if(!((Az[0]>=Az[2])||(Az[1]>=Az[3]))){var
...
Set(8,Ay.slice(2,4));for(i=0;i<9;i=i+1)if(this.O0(Bv.Get(i)))return B._NewObject(
C.KU,0).Initialize(this,B.aaj(Bv.Get(i),Bv.Get(0)));}return null;},RY:function(E
){if(E<1)E=1;this.LA=E;},M6:function(E){if(E<1)E=1;this.RO=E;},Ar:function(E){if(
E)this.Bn(0x10,0x0);else this.Bn(0x0,0x10);},_Init:function(aArg){C.Fu._Init.call(
this,aArg);this.__proto__=C.B2;this.I=0x11B;},_Mark:function(D){var A;C.Fu._Mark.
call(this,D);if((A=this.Pp)&&((A=A[0])._cycle!=D))A._Mark(A._cycle=D);if((A=this.
...
timer:null,N_:null,KI:null,Aq:0,NA:0,FS:5000,JH:0,NY:B.vw,Jk:0,GQ:0,AY:0,Iz:0,KM:
0,Jj:0,GP:0,AX:0,Iy:0,Ix:0,C4:B.vw,Rq:B.vw,B_:B.vw,B$:B.vw,AN:B.vw,Ru:0.5,Nc:true
,Kb:false,EM:false,EN:false,Nz:false,L6:0,DY:function(Bd,aClip,aOffset,A1,aBlend
){},BI:function(AG){var A;var Ab=(C.Gh.isPrototypeOf(AG)?AG:null);var AJ=(C.JS.isPrototypeOf(
AG)?AG:null);var BO=(C.KT.isPrototypeOf(AG)?AG:null);var Fh;var Ef;var Mq;var CO;
var LY;Fh=(!!Ab&&Ab.Down)&&!Ab.B0;Ef=(!!Ab&&Ab.Down)&&(Ab.B0>0);Mq=(!!Ab&&Ab.Down
)&&(Ab.B0>this.L6);CO=!!Ab&&!Ab.Down;LY=!!AJ;if(Fh)this.L6=((A=(Ab.Dm?0:50))&0x80
)?A|0xFFFFFF00:A&0xFF;if(Fh){var Ju=0;var FR;this.Aq=this.Aq|(1<<Ab.BR);for(FR=this.
Aq&4095;FR>0;FR=FR>>1)if(!!(FR&1))Ju=Ju+1;if(Ju===1)this.Aq=(this.Aq|16777216)|(
4096<<Ab.BR);}if(CO&&(this.Aq<16777216)){var DD=this.II();var B6=null;if(!!DD){var
Q$=(!!this.Au?this.Au:this.L);B6=DD.Fm(B.aam(Nh,Ab.Cy),Ab.BR,Ab.CV,null,Q$,0x0);
}if(!!B6){var i;for(i=0;i<10;i++)if(!!(this.Aq&(1<<i)))B6.Cu.BI(B._NewObject(C.Gh
,0).InitializeDown(i,Ab.BU,Ab.CV,A9,true,Ab.Cy));for(i=0;i<10;i++)if(!!(this.Aq&(
1<<i)))B6.Cu.BI(B._NewObject(C.Gh,0).InitializeUp(i,Ab.BU,Ab.BU,0,Ab.CV,A9,false
,Ab.Cy,Ab.Cy));}}if(CO)this.Aq=(this.Aq&~(1<<Ab.BR))|33554432;if(Mq&&(this.Aq<16777216
))this.Aq=this.Aq|67108864;if(CO&&Ab.Dm)this.Aq=this.Aq|67108864;if(CO&&!(this.Aq&
16777215))this.Aq=0;if(Ef&&(this.Aq>=67108864)){var DD=this.II();if(!!DD)DD.PY(null
...
BR)))return this;if(CO&&!(this.Aq&16777216))return this;if(((Fh||LY)||Ef)&&((this.
...
BO.Down)&&(this.Nz||!this.Kb))return null;if((!!BO&&BO.Down)&&!B.vt(this.R,this.
L.RL(BO.Cy)))return null;if((!!BO&&!BO.Down)&&(!this.Nz||(this.NA!==BO.BR)))return null;
if((!Ab&&!AJ)&&!BO)return null;if(!!Ab){this.Nz=Fh||Ef;this.NA=Ab.BR;this.C4=Ab.
C4;}if(!!AJ)this.NA=AJ.BR;if(!!BO){this.Nz=BO.Down;this.NA=BO.BR;}if(!!BO&&BO.Down
){this.Rb();this.AX=(((BO.AF-this.Ix)*0.001)*this.GP)+this.AX;this.AY=(((BO.AF-this.
KM)*0.001)*this.GQ)+this.AY;if(this.EM)this.AX=0;if(this.EN)this.AY=0;this.GP=0;
this.GQ=0;this.EM=false;this.EN=false;this.NY=this.AN;this.JH=BO.AF;return this;
}if(Fh){this.Rb();this.AX=(((Ab.AF-this.Ix)*0.001)*this.GP)+this.AX;this.AY=(((Ab.
...
Kb=true;(A=this.N_)?A[1].call(A[0],this):null;}this.NY=this.AN;this.JH=Ab.AF;}if(
!!AJ){var Cd=B.aaj(AJ.BU,AJ.C4);var AI=this.AN;if(this.Nc)AI=[this.NY[0]+Cd[0],AI[
1]];AI=[AI[0],this.NY[1]+Cd[1]];if(AI[0]<this.B$[0])AI=[this.B$[0]+(((AI[0]-this.
...
!B.z8(AI,this.AN)){this.Rq=B.aaj(AI,this.AN);this.AN=AI;(A=this.KI)?A[1].call(A[
...
Cd=AJ.AN;var S8=1000/(AJ.AF-this.JH);var HJ=0;var HK;if(this.Nc)HJ=Cd[0]*S8;HK=Cd[
1]*S8;if((HJ*this.AX)<0)this.AX=0;if((HK*this.AY)<0)this.AY=0;this.AX=(this.AX+HJ
)*0.5;this.AY=(this.AY+HK)*0.5;this.JH=AJ.AF;}if(!CO&&!BO)return this;if(!!Ab&&Ab.
Dm){this.AX=0;this.AY=0;}if((this.AN[0]<=this.B$[0])||(this.AN[0]>=this.B_[0]))this.
...
400-(this.AX*this.AX))/(2*CK);this.Jj=A_;}}else{var Aas=this.AX*this.AX;var CK=Aas
/(2*this.FS);var A_=this.AN[0];if(this.AX>0)A_=A_+(CK|0);if(this.AX<0)A_=A_-(CK|
0);if(A_>this.B_[0])A_=this.B_[0];else if(A_<this.B$[0])A_=this.B$[0];var TY=A_;
...
else A_=BH;if(A_!==this.AN[0]){CK=A_-this.AN[0];if(A_!==TY){var HS=A_-TY;if(HS>0
...
var Aat=this.AY*this.AY;var CK=Aat/(2*this.FS);var A$=this.AN[1];if(this.AY>0)A$=
A$+(CK|0);if(this.AY<0)A$=A$-(CK|0);if(A$>this.B_[1])A$=this.B_[1];else if(A$<this.
B$[1])A$=this.B$[1];var TZ=A$;var BG=this.B$[1];var BH=this.B_[1];if(A$<BG)BH=this.
...
A$!==TZ){var HS=A$-TZ;if(HS>0)this.AY=this.AY+Math.sqrt((HS*2)*this.FS);if(HS<0)
...
0];this.Iz=this.AN[1];this.Aau();return this;},Fm:function(Ay,Ac,C_,FC,FG,FF){var
A;if(!!FC&&(FC!==this))return null;if(this.Aq>=33554432)return null;if((this.Aq>=
16777216)&&!(this.Aq&(4096<<Ac)))return null;if(!this.Nc&&!!(FF&0xC))return null;
...
1])-1];return B._NewObject(C.KU,0).Initialize(this,Bm);}return null;},Rb:function(
){if(!!this.timer){B.zl([this,this.De],this.timer,0);this.timer=null;}},Aau:function(
...
timer.AF-this.KM)*0.001;var Aaw=KO*KO;var Aax=KP*KP;var HJ=(this.GP*KO)+this.AX;
var HK=(this.GQ*KP)+this.AY;var AI=[((((this.GP*0.5)*Aaw)+(this.AX*KO))+this.Iy)|
0,((((this.GQ*0.5)*Aax)+(this.AY*KP))+this.Iz)|0];if(this.EM&&(KO>=0.5)){AI=[this.
...
1]];}if(!this.EM&&(AI[0]<this.B$[0])){this.Iy=AI[0];this.Jj=this.B$[0];this.Ix=this.
timer.AF;this.EM=true;}else if(!this.EM&&(AI[0]>this.B_[0])){this.Iy=AI[0];this.
Jj=this.B_[0];this.Ix=this.timer.AF;this.EM=true;}if(!this.EN&&(AI[1]<this.B$[1]
)){this.Iz=AI[1];this.Jk=this.B$[1];this.KM=this.timer.AF;this.EN=true;}else if(
!this.EN&&(AI[1]>this.B_[1])){this.Iz=AI[1];this.Jk=this.B_[1];this.KM=this.timer.
...
this.Rq=B.aaj(AI,this.AN);this.AN=AI;(A=this.KI)?A[1].call(A[0],this):null;}if(((
!this.AX&&!this.AY)&&!this.EM)&&!this.EN){this.Rb();this.Kb=false;}},U0:function(
E){if(E<0)E=0;if(E>1)E=1;if(E===this.Ru)return;this.Ru=E;if(E<(1e-007))E=1e-007;
this.FS=E*10000;},_Init:function(aArg){C.B1._Init.call(this,aArg);this.__proto__=
C.D2;this.I=0x11B;},_Mark:function(D){var A;C.B1._Mark.call(this,D);if((A=this.timer
)&&(A._cycle!=D))A._Mark(A._cycle=D);if((A=this.N_)&&((A=A[0])._cycle!=D))A._Mark(
A._cycle=D);if((A=this.KI)&&((A=A[0])._cycle!=D))A._Mark(A._cycle=D);},_className:
"Core::SlideTouchHandler"};C.Cj={Aj:null,Ck:null,BS:null,EZ:null,JG:0,AF:0,R2:0,
CD:148,BB:0,AD:0,Bo:true,Down:false,PW:false,Do:false,Ai:function(aArg){var A;var
A3=(C.O.isPrototypeOf(A=this.G)?A:null);if(!A3)throw new Error(Qf);this.Aj=A3.N0;
A3.N0=this;},BI:function(AG){var A;if(!!AG&&AG.Ul(this.CD)){this.Down=AG.Down;this.
BB=AG.BB;this.AD=AG.AD;this.AF=AG.AF;this.Do=false;if(AG.Down){this.R2=this.JG;this.
PW=this.JG>0;if(this.PW)(A=this.EZ)?A[1].call(A[0],this):null;else(A=this.BS)?A[
1].call(A[0],this):null;if(!this.Do)this.JG=this.JG+1;return!this.Do;}if(!AG.Down
){this.PW=this.JG>1;this.R2=this.JG-1;this.JG=0;(A=this.Ck)?A[1].call(A[0],this):
...
};C.JV={Iq:null,Cf:B.vx,Ap:B.vx,isEmpty:false,_Init:function(aArg){this.__proto__=
...
"Core::LayoutContext"};C.ML={HN:B.vw,HM:B.vw,_Init:function(aArg){C.JV._Init.call(
this,aArg);this.__proto__=C.ML;},_className:"Core::LayoutLineContext"};C.MM={Ml:
B.vw,Mk:B.vw,HN:B.vw,HM:B.vw,_Init:function(aArg){C.JV._Init.call(this,aArg);this.
__proto__=C.MM;},_className:"Core::LayoutQuadContext"};C.OD={A3:null,Aj:null,DQ:
null,DW:null,CA:null,JE:null,_Init:function(aArg){this.__proto__=C.OD;B.hJ++;},_Done:
function(){this.__proto__=null;B.hJ--;},_ReInit:function(){},_Mark:function(D){var
...
};C.P4={DO:null,Bl:null,AV:null,S_:false,Zh:function(){if(!this.DO)return;var Dj=
this.DO;this.DO.Di=null;this.DO=null;B.ow([this,this.Q2],this);Dj.RQ(this);},ZQ:
function(M){if(!!this.DO)return;if(!this.AV)return;this.DO=this.AV;this.AV=this.
AV.Aj;if(!!this.AV)this.AV.Au=null;else this.Bl=null;this.DO.Aj=null;this.S_=true;
this.DO.J7(this);this.S_=false;},Z4:function(M){B.ow([this,this.ZQ],this);},Z3:function(
M){B.ow([this,this.Z4],this);},Q2:function(M){B.ow([this,this.Z3],this);},T$:function(
BV){if(!BV||!BV.Di)return;if(BV.Di!==this)throw new Error(Qg);var T4=false;if(this.
DO===BV){this.DO=null;T4=true;B.ow([this,this.Q2],this);}else{if(!!BV.Aj)BV.Aj.Au=
BV.Au;else this.Bl=BV.Au;if(!!BV.Au)BV.Au.Aj=BV.Aj;else this.AV=BV.Aj;BV.Au=null;
BV.Aj=null;}BV.Di=null;if(T4)BV.RP(this);},R3:function(BV,Qu){if(!BV)return;if(!
!BV.Di)throw new Error(Ni);BV.Di=this;if(Qu){BV.Aj=this.AV;if(!!this.AV)this.AV.
Au=BV;else this.Bl=BV;this.AV=BV;}else{BV.Au=this.Bl;if(!!this.Bl)this.Bl.Aj=BV;
else this.AV=BV;this.Bl=BV;}if(!this.DO)B.ow([this,this.Q2],this);},_Init:function(
aArg){this.__proto__=C.P4;B.hJ++;},_Done:function(){this.__proto__=null;B.hJ--;}
...
null,Aj:null,RQ:function(Ku){},RP:function(Ku){},J7:function(Ku){this.Ro();},HT:
function(){if(!!this.Di&&(this.Di.DO===this))this.Di.Zh();},Ro:function(){if(!!this.
Di)this.Di.T$(this);},OZ:function(){return!!this.Di&&(this.Di.DO===this);},_Init:
...
D);},G:null,_cycle:0,_observers:null,_className:"Core::Task"};C.P3={Y:null,KN:null
,J7:function(Ku){this.KN.Y=this.Y;B.vv(this.KN,0);B.ow([this,this.ZO],this);},ZO:
function(M){this.KN.Y=null;this.KN=null;this.Y=null;this.HT();},_Init:function(aArg
){C.H9._Init.call(this,aArg);this.__proto__=C.P3;},_Mark:function(D){var A;C.H9.
_Mark.call(this,D);if((A=this.Y)&&(A._cycle!=D))A._Mark(A._cycle=D);if((A=this.KN
)&&(A._cycle!=D))A._Mark(A._cycle=D);},_className:"Core::SystemEventTask"};C.Ne={
_Init:function(){C.P4._Init.call(this,0);},_variants:function(){return this;},_this:
...
Period:1000,Mw:0,Bo:false,Ep:function(){var tmp=this.timer;if(!!tmp)tmp.DestroyTimer(
);this.timer=null;},N$:function(aBegin,aPeriod){if(aBegin<0)aBegin=0;if(aPeriod<
...
Bo)this.N$(this.Mw,E);},E0:function(E){if(E<0)E=0;if(E===this.Mw)return;this.Mw=
E;if(this.Bo)this.N$(E,this.Period);},Ar:function(E){if(E===this.Bo)return;this.
Bo=E;if(E)this.N$(this.Mw,this.Period);else this.N$(0,0);this.AF=this.MG();},MG:
function(){var ticksCount=0;ticksCount=((new Date).getTime()-B.vs)|0;return ticksCount;
},Trigger:function(){var A;this.AF=this.MG();if(!this.Period)this.Ar(false);(A=this.
...
null,_className:"Core::Timer"};C.R6={Y:null,Di:null,Trigger:function(Y4,Qu){var Dj=
B._NewObject(C.P3,0);Dj.KN=this;Dj.Y=Y4;this.Di.R3(Dj,Qu);},_Init:function(aArg){
this.__proto__=C.R6;this.Di=B._GetAutoObject(C.Ne);B.hJ++;},_Done:function(){this.
__proto__=null;B.hJ--;},_ReInit:function(){},_Mark:function(D){var A;if((A=this.
...
null,_className:"Core::SystemEvent"};C.Nd={Oz:null,Event:null,A8:null,Jy:function(
M){var A;if(!this.Event)return;this.Oz=this.Event.Y;(A=this.A8)?A[1].call(A[0],this
):null;this.Oz=null;},PG:function(E){if(this.Event===E)return;if(!!this.Event)B.
zl([this,this.Jy],this.Event,0);this.Event=E;if(!!this.Event)B.y_([this,this.Jy]
,this.Event,0);},_Init:function(aArg){this.__proto__=C.Nd;B.hJ++;},_Done:function(
){this.__proto__=null;B.hJ--;},_ReInit:function(){},_Mark:function(D){var A;if((
A=this.Oz)&&(A._cycle!=D))A._Mark(A._cycle=D);if((A=this.Event)&&(A._cycle!=D))A.
...
,_cycle:0,_observers:null,_className:"Core::PropertyObserver"};C.AbT={E8:0x1,AaL:
0x2,AaZ:0x4,AbR:0x8,Bo:0x10,Abz:0x20,Aa0:0x40,Abb:0x80,AaY:0x100,Aa8:0x200,AaW:0x400
,Abm:0x800,R7:0x1000,AbS:0x2000,Abk:0x4000,Abl:0x8000,AaT:0x10000,Abj:0x20000,Abw:
0x40000};C.Dt={Abn:0x1,Abo:0x2,AaH:0x4,AaI:0x8,AaJ:0x10,AaG:0x20};C.Aa2={Abe:0,AbO:
1,AaN:2,Aa9:3,Abq:4,AbP:5,AbQ:6,AaO:7,AaP:8,Aa$:9,Aa_:10,Abs:11,Abr:12};C.KeyCode={
...
343,ShiftHome:344,ShiftEnd:345,ShiftTab:346};C.Abp={Ab0:0x1,AbX:0x2,AbY:0x4,AbZ:
0x8,Aba:0x10,Aa1:0x20};
C._Init=function(){C.JX.__proto__=C.Cu;C.Fu.__proto__=C.Cu;C.B1.__proto__=C.Cu;C.
O.__proto__=C.B1;C.Root.__proto__=C.O;C.KeyEvent.__proto__=C.Event;C.KT.__proto__=
C.Event;C.Gh.__proto__=C.Event;C.JS.__proto__=C.Event;C.Lw.__proto__=C.B1;C.B2.__proto__=
C.Fu;C.D2.__proto__=C.B1;C.ML.__proto__=C.JV;C.MM.__proto__=C.JV;C.P3.__proto__=
C.H9;};C._ReInit=function(){var A;if((A=C.Ne._this))A._ReInit();};C.C9=function(
D){var A;if((A=C.Ne._this)&&(A._cycle!=D))A._Done(C.Ne._this=null);};return C;})(
);
